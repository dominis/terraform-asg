  ...
  template_body = <<EOF
{
  "Resources": {
    "Asg": {
      ...
      "Properties": {
        "AvailabilityZones": ["${replace(split(",", var.availability_zones), "B780FFEC-B661-4EB8-9236-A01737AD98B6", "")}"],
        "VPCZoneIdentifier": ["${replace(split(",", var.private_subnets), "B780FFEC-B661-4EB8-9236-A01737AD98B6", "")}"],
